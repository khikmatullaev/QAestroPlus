...
ts=$(date +%s%N)
    # Generate mappings
    ./mcdsat_endec.py -a generate -i $1 -m mappings.tmp -c mappingCosts.tmp
    ...
    # Execute mcdsat
    ./mcdsat/mcdsat RW $1_mcdsat.tmp $2_mcdsat.tmp $4 $5 mappingCosts.tmp  > output_mcdsat.tmp
...
rm mappings.tmp mappingCosts.tmp output_mcdsat.tmp $1_mcdsat.tmp $2_mcdsat.tmp
